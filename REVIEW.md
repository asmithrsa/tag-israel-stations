...
## Included but unconfirmed (2)

These are in `stations.csv`. Delete any that are not actually open.

| Station | OSM | Coords | Why flagged |
|---|---|---|---|
| Shomron – Tayyiba | `node/13626956323` | 32.27634, 34.99660 | no wikidata ref and no operator tag, so it is not a catalogued Israel Railways station; added to OSM recently (2025+), which usually means a new build - confirm it has actually opened |
| Tira - Kokhav Ya'ir | `node/13964778722` | 32.22966, 34.97701 | added to OSM recently (2025+), which usually means a new build - confirm it has actually opened |
